...
void SPI_init()
{
    ...
    SysCtlDelay(3);
    SysCtlPeripheralEnable(SYSCTL_PERIPH_GPIOD);    //SPI and CS LCD
    SysCtlDelay(3);
    SysCtlPeripheralEnable(SYSCTL_PERIPH_GPIOA);    //CS SD Card
    SysCtlDelay(3);
...
//    GPIOPinTypeSSI(GPIO_PORTD_BASE, GPIO_PIN_1);
    ...
    SSIConfigSetExpClk(SSI3_BASE, 80000000, SSI_FRF_MOTO_MODE_0,SSI_MODE_MASTER, 12000000, 8);
    SysCtlDelay(3);
