...
#else
 #define configPRIO_BITS         3      //Tiva uses the top 3 bits
#endif
...
////////////////////////////////////////////
//FreeRTOS TickHandler - 
//See FreeRTOSTick.h/.c in FreeRTOS project folder
//The RTOS tick is mapped to either the systick or one
//of the Tiva timers (Timer0A, Timer1A, or Timer2A).  
...
//
//See RunTimeStats.h/.c for function defs and prototypes
//for vConfigureTimerForRunTimeStats and ulGetRunTimeCounterValue
//
#define configUSE_TRACE_FACILITY                    1
